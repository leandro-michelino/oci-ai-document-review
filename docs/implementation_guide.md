...
5. Select an individual Dashboard row and open it with Review selected. For multi-file submissions, confirm the compact group opens the best next actionable file and keeps the file table under Show files.
