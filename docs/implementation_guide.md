...
5. Open the record from Dashboard with Review. For multi-file submissions, confirm the compact group opens the best next actionable file and keeps the file table under Show files.
