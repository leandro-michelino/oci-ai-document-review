...
- Reset the browser Upload form after a successful queue operation, with test coverage that the uploader key changes and only upload-specific form values are cleared.
