...
- Dashboard queue view with metrics, next-action guidance, search, collapsed expense groups, active elapsed time, tabbed queue sections, shortcuts, compact multi-file Review cards, and collapsed file details
