...
- Actions page for prioritized approvals, top Decision panel, linked-file context, group aggregation, source-document download, assignment, SLA tracking, comments, audit trail, retry history, failed-document follow-up, AI summary, lifecycle, extracted text, and downloads
